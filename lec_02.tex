...
\end{proof}
Als nächstes: \( \affindim{Y_1\vee Y_2} \) ist durch \( \fielddim-{K}{T(Y_1\vee Y_2)} \) gegeben, also sollten wir aus \thref{verbindungsraum:translationen} für \( Y_1\vee Y_2 \) ableiten können.
